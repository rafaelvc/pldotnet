...
//    return DotNET_callhandler( /* additional args, */ fcinfo);
    ...
    PG_TRY();
    {
...
#ifdef USE_DOTNETBUILD
        char *filename;
        filename = palloc0(strlen(dnldir) + strlen("/src/csharp/Lib.cs") + 1);
        SNPRINTF(filename, strlen(dnldir) + strlen("/src/csharp/Lib.cs") + 1
                        , "%s/src/csharp/Lib.cs", dnldir);
        ...
        //
        char *config_path;
        config_path = palloc0(strlen(root_path) + strlen("/src/csharp/DotNetLib.runtimeconfig.json") + 1);
        SNPRINTF(config_path, strlen(root_path) + strlen("/src/csharp/DotNetLib.runtimeconfig.json") + 1
                        , "%s/src/csharp/DotNetLib.runtimeconfig.json", root_path);
        ...
        //
        char *dotnetlib_path;
        dotnetlib_path = palloc0(strlen(root_path) + strlen("/src/csharp/DotNetLib.dll") + 1);
        SNPRINTF(dotnetlib_path,strlen(root_path) + strlen("/src/csharp/DotNetLib.dll") + 1
                        , "%s/src/csharp/DotNetLib.dll", root_path);
