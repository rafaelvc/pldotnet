...
typedef int32_t
(HOSTFXR_CALLTYPE *hostfxr_main_fn)(const int argc, const char_t **argv);
...
typedef void
(HOSTFXR_CALLTYPE *hostfxr_error_writer_fn)(const char_t *message);
...
typedef int32_t
(HOSTFXR_CALLTYPE *hostfxr_run_app_fn)(const hostfxr_handle host_context_handle);
